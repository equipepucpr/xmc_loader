...
/*
 * Retrieves the version of the RTC driver
 */
XMC_DRIVER_VERSION_t XMC_RTC_GetDriverVersion(void)
{
  XMC_DRIVER_VERSION_t version;

  version.major = (uint8_t)XMC_RTC_MAJOR_VERSION;
  version.minor = (uint8_t)XMC_RTC_MINOR_VERSION;
  version.patch = (uint8_t)XMC_RTC_PATCH_VERSION;
