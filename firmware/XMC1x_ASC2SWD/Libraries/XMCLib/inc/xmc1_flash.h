 ...
 * Version 1.0.2 Updated for Documentation related changes<br>  
 */
...
#define XMC_FLASH_MAJOR_VERSION    (1U)     /**< Major number of the driver version, which is,
                                                 \<major.\<minor\>.\<patch\> */
#define XMC_FLASH_MINOR_VERSION    (0U)     /**< Minor number of the driver version, which is,
                                                 \<major.\<minor\>.\<patch\> */
#define XMC_FLASH_PATCH_VERSION    (2U)     /**< Minor number of the driver version, which is,
                                                 \<major.\<minor\>.\<patch\> */
