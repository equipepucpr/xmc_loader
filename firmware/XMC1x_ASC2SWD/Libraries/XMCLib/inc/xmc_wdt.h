...
#define XMC_WDT_MAJOR_VERSION          (1U) /**< Major number of the driver version(\<major\>.\<minor\>.\<patch\>) */
#define XMC_WDT_MINOR_VERSION          (0U) /**< Minor number of the driver version(\<major\>.\<minor\>.\<patch\>) */
#define XMC_WDT_PATCH_VERSION          (2U) /**< Patch number of the driver version(\<major\>.\<minor\>.\<patch\>) */
