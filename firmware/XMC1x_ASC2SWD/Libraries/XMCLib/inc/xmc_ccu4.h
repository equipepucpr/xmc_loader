...
#define XMC_CCU4_MAJOR_VERSION (1U) /**< Major number of the driver version. Format \<major\>.\<minor\>.\<patch\> */
#define XMC_CCU4_MINOR_VERSION (0U) /**< Minor number of the driver version. Format \<major\>.\<minor\>.\<patch\> */
#define XMC_CCU4_PATCH_VERSION (2U) /**< Patch number of the driver version. Format \<major\>.\<minor\>.\<patch\> */
