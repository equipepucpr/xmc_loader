 ...
 * This file contains code (data types, data structures, text) of MATH library routines.
 * 
 * History <br>
 *
 * Version 1.0.0 Initial version <br>
 * Version 1.0.2 Driver description is added. <br>
 */
 ...
 * MACROS
 ********************************************************************************************************************/
#define XMC_MATH_MAJOR_VERSION (1U) /**< Version number : Major version */
#define XMC_MATH_MINOR_VERSION (0U) /**< Version number : Minor version */
#define XMC_MATH_PATCH_VERSION (2U) /**< Version number : Patch version */
 ...
 * Each of the XMC low level drivers export a version (major, minor and patch number) number.
