 ...
 * Version 1.0.2 Help document updated <br>
 */
 ...
 * MACROS
 ********************************************************************************************************************/
#define XMC_LEDTS_MAJOR_VERSION (1U)             /**< Major number of the driver version, which is,
                                                      \<major\>.\<minor\>.\<patch\> e.g. 1.2.3.*/
#define XMC_LEDTS_MINOR_VERSION (0U)             /**< Minor number of the driver version, which is,
                                                      \<major\>.\<minor\>.\<patch\> e.g. 1.2.3.*/
#define XMC_LEDTS_PATCH_VERSION (2U)             /**< Patch number of the driver version, which is,
                                                      \<major\>.\<minor\>.\<patch\> e.g. 1.2.3.*/
